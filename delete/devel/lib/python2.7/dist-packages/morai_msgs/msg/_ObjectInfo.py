...
class ObjectInfo(genpy.Message):
  _md5sum = "544b34f9a8049dbcfd23f36a6d3ad887"
...
string frame_id
"""
  __slots__ = ['header','num_of_objects','object_type','pose_x','pose_y','pose_z','heading','size_x','size_y','size_z','velocity']
  _slot_types = ['std_msgs/Header','int32','int16[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,num_of_objects,object_type,pose_x,pose_y,pose_z,heading,size_x,size_y,size_z,velocity
