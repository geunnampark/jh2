...
class MultiEgoSetting(genpy.Message):
  _md5sum = "85b5d78cb72bc5fbab1e8feb46c3ad47"
...
int8[] gear
"""
  __slots__ = ['number_of_ego_vehicle','camera_index','ego_index','global_position_x','global_position_y','global_position_z','global_roll','global_pitch','global_yaw','velocity','gear']
  _slot_types = ['int32','int32','int32[]','float64[]','float64[]','float64[]','float32[]','float32[]','float32[]','float32[]','int8[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       number_of_ego_vehicle,camera_index,ego_index,global_position_x,global_position_y,global_position_z,global_roll,global_pitch,global_yaw,velocity,gear
