...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MultiEgoSetting>)))
  ...
  "85b5d78cb72bc5fbab1e8feb46c3ad47")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MultiEgoSetting)))
  "Returns md5sum for a message object of type 'MultiEgoSetting"
  "85b5d78cb72bc5fbab1e8feb46c3ad47")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MultiEgoSetting>)))
  ...
  (cl:format cl:nil "int32 number_of_ego_vehicle~%int32 camera_index~%int32[] ego_index~%float64[] global_position_x~%float64[] global_position_y~%float64[] global_position_z~%float32[] global_roll~%float32[] global_pitch~%float32[] global_yaw~%float32[] velocity~%int8[] gear~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MultiEgoSetting)))
  "Returns full string definition for message of type 'MultiEgoSetting"
  (cl:format cl:nil "int32 number_of_ego_vehicle~%int32 camera_index~%int32[] ego_index~%float64[] global_position_x~%float64[] global_position_y~%float64[] global_position_z~%float32[] global_roll~%float32[] global_pitch~%float32[] global_yaw~%float32[] velocity~%int8[] gear~%~%~%"))
