...
from cbnu_msgs.msg import VehicleCmd
...
class purePursuit :
    ...
    def getEgoStatus(self,msg):
        ...
        self.current_postion.x=msg.ned_longitude
        self.current_postion.y=msg.ned_latitude
        self.current_postion.z=msg.ned_heading
