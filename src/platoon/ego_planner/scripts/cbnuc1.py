...
from cbnu_msgs.msg import VehicleCmd,VehicleTlm   #fix
...
ego_mode_set = VehicleCmd()

ego_mode_set.longlCmdType = 2
ego_mode_set.gear_cmd = 3
...
class purePursuit :
    ...
    def getEgoStatus(self,msg):
        ...
        self.current_postion.x=msg.ned_latitude
        self.current_postion.y=msg.ned_longitude
        self.current_postion.z=0  # msg.pose.z => 0   #fix
...
def controller():
    ...
    ctrl_pub = rospy.Publisher(ctrl_name,VehicleCmd, queue_size=1)  #fix       

    #rospy.Subscriber(vehicle_status_name, VehicleStatus, egoVehicleCB) 
    rospy.Subscriber(vehicle_status_name, VehicleTlm, egoVehicleCB)  #fix
    ...
    while not rospy.is_shutdown():
        ...
        #current_velocity=ego_vehicle_msg.velocity*3.6 
        current_velocity=ego_vehicle_msg.speed*3.6   #fix  , kph 
