...
def planner():
    ...
    node_name='planner4'
    target_vel_name='target_vel4'
    global_path_name='global_path4'
    local_path_name='local_path4'
    odom_name='odom4'
    vehicle_status_name='vehicle_status4'
    object_topic ='Object_topic4'
    ...
    #cruise_control=cruiseControl(1,1.9)
